        ...
        <div class="row content">
            ...
            <c:if test = "${sessionScope.user != null}">
                ...
                <div class="col-md-10 accessories">
                    ...
                    <h2 class="accessories__title">"Empathy is about finding echoes of another person in yourself"</h2>
                    <p style="color:#009879; font-weight: bold">${mess}</p>
                    <div class="accessories__list">
                        <c:forEach items="${data}" var="item">

                            <div class="accessories__list__item">
                                <a href="searchanother?bid=${item.getId()}">                  
