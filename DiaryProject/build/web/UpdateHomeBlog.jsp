...
<html>
    ...
    <body>
        ...
        <div>
            ...
            <h1 class="accessories__title">EDIT YOUR STORY</h1>

            <div class="container">
                <form action="updatehomeblog" method="post">  

                    <label for="subject">Title</label>
                    <textarea id="subject" name="title" placeholder="Write your title.." style="height:100px" required="required">${detail.getTitle()}</textarea>
                    <label for="fname">Date</label>
                    <input type="date" name="date" value="${detail.getDate()}" required="required">
                    <br>
                    <label for="fname">Image</label>
                    <input type="text" name="image" placeholder="Image link.." value="${detail.getImage()}" required="required">
                    <label for="subject">Text</label>
                    <textarea id="subject" name="text" placeholder="Write your story.." style="height:200px" required="required">${detail.getText()}</textarea>
