                            ...
                            <div class="accessories__list__item">
                                ...
                                <div class="row accessories__list__item__info">
                                    ...
                                    <div class="col-md-9 ">
                                        ...
                                        <button class="edit-button"><a href="updatehomeblog?bid=${item.getId()}"><img src="https://cdn-icons-png.flaticon.com/512/1827/1827951.png" width="20" height="20" alt="alt"/></a></button>
                                    <button class="edit-button"><a href="deletehomeblog?bid=${item.getId()}"><img src="https://cdn-icons-png.flaticon.com/512/3405/3405244.png" width="20" height="20" alt="alt"/></a></button>
                                     <button class="edit-button"><a href="favourite?bid=${item.getId()}"><img src="https://img.freepik.com/free-vector/start_53876-25533.jpg" width="20" height="20" alt="alt"/></a></button>
                                             <c:if test="${item.getFavourite() == 1}">
                                         <p style="color:red">My Favourite</p>
                                             </c:if>
                            </div>
                        </c:forEach>
