    ...
    <body>
        ...
        <div class="row content">
            ...
            <div class="col-md-10 accessories">
                <h1 class="accessories__title">My Story Management</h1>
                <div class="alarm">${mess}</div>
                <form action="searchblogname" method="post">
                    <div class="search-box">
                        ...
                        <input type="text" name="text" class="input-search" placeholder="Search Tittle...">  
                    </div>
                </form>
                
                
                <div>
                    <button class="my-button"><a href="AddBlog.jsp">ADD NEW STORY</a></button>
                ...
                <table class="styled-table">
                    <thead>
                        <tr>
                            ...
                            <th>TITLE</th>
                            <th class ="icon">DATE
                                <a href="orderdate"><img src="https://img.icons8.com/dotty/256/generic-sorting.png" width="30" height="30" class ="icon" alt="alt"/></a></th>
                            <th>IMAGE</th>
                            <th>TEXT</th>
                            <th>EDIT</th>
                        </tr>
                    ...
                    <div class="alo">
                        <c:forEach items="${data}" var="item">
                            <tr>
                                ...
                                <td>${item.getText()}</td> 
                                <td>                      
                                    <button class="edit-button"><a href="updateblog?bid=${item.getId()}"><img src="https://cdn-icons-png.flaticon.com/512/1827/1827951.png" width="20" height="20" alt="alt"/></a></button>
                                    <button class="edit-button"><a href="deleteblog?bid=${item.getId()}"><img src="https://cdn-icons-png.flaticon.com/512/3405/3405244.png" width="20" height="20" alt="alt"/></a></button>
                                </td>
